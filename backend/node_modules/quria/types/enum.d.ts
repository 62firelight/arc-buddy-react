export declare enum ApplicationScopes {
...
export declare enum IgnoreLength {
    None = 0,
    Week = 1,
    TwoWeeks = 2,
    ThreeWeeks = 3,
...
export declare enum ChatSecuritySetting {
    Group = 0,
    Admins = 1
}
...
export declare enum MembershipOption {
    Reviewed = 0,
    Open = 1,
    Closed = 2
}
...
export declare enum GroupAllianceStatus {
    Unallied = 0,
    Parent = 1,
    Child = 2
}
...
export declare enum GroupDateRange {
    All = 0,
    PastDay = 1,
    PastWeek = 2,
    PastMonth = 3,
...
export declare enum GroupSortBy {
    Name = 0,
    Date = 1,
    Popularity = 2,
    Id = 3
}
export declare enum GroupMemberCountFilter {
    All = 0,
    OneToTen = 1,
...
export declare enum ForumTopicsSortEnum {
    Default = 0,
    LastReplied = 1,
    MostReplied = 2,
    Popularity = 3,
...
export declare enum ForumMediaType {
    None = 0,
    Image = 1,
    Video = 2,
    Youtube = 3
...
export declare enum ForumPostSortEnum {
    Default = 0,
    OldestFirst = 1
}
...
export declare enum ForumPostCategoryEnums {
    None = 0,
    TextOnly = 1,
    Media = 2,
    Link = 4,
...
export declare enum ForumFlagsEnum {
    None = 0,
    BungieStaffPost = 1,
    ForumNinjaPost = 2,
    ForumMentorPost = 4,
...
export declare enum DestinyStatsMergeMethod {
    Add = 0,
    Min = 1,
    Max = 2
}
...
export declare enum DropStateEnum {
    Claimed = 0,
    Applied = 1,
    Fulfilled = 2
}
...
export declare enum FireteamDateRange {
    All = 0,
    Now = 1,
    TwentyFourHours = 2,
    FortyEightHours = 3,
...
export declare enum FireteamSlotSearch {
    NoSlotRestriction = 0,
